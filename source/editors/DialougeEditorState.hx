...
class DialougeEditorState extends FlxUIState
{
    ...
    override function create()
    {
		...
		portLab.setFormat(PathGenerator.getFont("8bitoperator_jve"), 24, FlxColor.WHITE, LEFT);
		...
		textLab.setFormat(PathGenerator.getFont("8bitoperator_jve"), 24, FlxColor.WHITE, LEFT);
		...
		speedLab.setFormat(PathGenerator.getFont("8bitoperator_jve"), 24, FlxColor.WHITE, LEFT);
		...
		continueLab.setFormat(PathGenerator.getFont("8bitoperator_jve"), 24, FlxColor.WHITE, LEFT);
		...
		skipLab.setFormat(PathGenerator.getFont("8bitoperator_jve"), 24, FlxColor.WHITE, LEFT);
		...
		totalCount.setFormat(PathGenerator.getFont("8bitoperator_jve"), 24, FlxColor.WHITE, LEFT);
		...
		{
			@:privateAccess
            openSubState(new editors.DialougeTestSState(dialouge_box.nicedialouge));
		});
