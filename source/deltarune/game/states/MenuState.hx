...
class MenuState extends State
{
	...
	public var dialogueEditButton:FlxButton;
	...
	override public function create()
	{
		...
		FlxG.sound.playMusic(GameAssets.music(Paths.getMusic('Before the Story')), 0.8, true);
		...
		{
			dialogueEditButton = new FlxButton(32, 425, "Edit Dialogue", function()
			{
				if (!inCredits && !leaving)
					FlxG.switchState(() -> new deltarune.editors.DialogueEditorState());
			});
			add(dialogueEditButton);
